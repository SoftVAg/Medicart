                    ...
                    <div className="row g-3">
                        ...
                        {type === "Register" && (
                            <div className="form-floating col-md-6">
                                <input
                                    type="text"
                                    className={`form-control ${(data["full-name"] && errors["full-name"]) ? "is-invalid" : ""}`}
                                    id="floatingName"
                                ...
                                {data["full-name"] && errors["full-name"] && <div className="invalid-feedback d-block">{errors["full-name"]}</div>}
                            </div>
                        )}
                        {type === "Register" && (
                            <div className="form-floating col-md-6">
                        ...
                        {type === "Register" && (
                            <div className="form-floating col-12">
                                <textarea
                                    className={`form-control ${data.address && errors.address ? "is-invalid" : ""}`}
                                    placeholder="Address"
                                    id="floatingAddress"
                                    name="address"
                                    value={data.address}
                                ...
                                {data.address && errors.address && <div className="invalid-feedback d-block">{errors.address}</div>}
                            </div>
                        )}
                        {type === "Register" && (
